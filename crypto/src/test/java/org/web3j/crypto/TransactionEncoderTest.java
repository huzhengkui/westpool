...
public class TransactionEncoderTest {
    ...
    public void testSignMessage() {
        byte[] signedMessage = TransactionEncoder.signMessage(
                createOkcerTransaction(), SampleKeys.CREDENTIALS);
    ...
    public void testEtherTransactionAsRlpValues() {
        List<RlpType> rlpStrings = TransactionEncoder.asRlpValues(createOkcerTransaction(),
    ...
    private static RawTransaction createOkcerTransaction() {
