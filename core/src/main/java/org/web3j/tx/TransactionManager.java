...
/**
 * Transaction manager abstraction for executing transactions with Okc client via
 * various mechanisms.
 */
public abstract class TransactionManager {
    ...
    private TransactionReceipt processResponse(OkcSendTransaction transactionResponse)
            throws IOException, TransactionException {
