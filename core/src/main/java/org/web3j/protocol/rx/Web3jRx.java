...
public interface Web3jRx {
     ...
     */
    Observable<OkcBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<OkcBlock> replayBlocksObservable(
     ...
     *                              in the {@link OkcBlock} responses
     ...
     */
    Observable<OkcBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<OkcBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
