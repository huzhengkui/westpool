 ...
 */
public class OkcSyncing extends Response<OkcSyncing.Result> {

    @Override
    @JsonDeserialize(using = OkcSyncing.ResponseDeserialiser.class)
    public void setResult(OkcSyncing.Result result) {
