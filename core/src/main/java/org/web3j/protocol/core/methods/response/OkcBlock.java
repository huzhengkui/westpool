 ...
 * <ul>
 * <li>okc_getBlockByHash</li>
 * <li>okc_getBlockByNumber</li>
 * <li>okc_getUncleByBlockHashAndIndex</li>
 * <li>okc_getUncleByBlockNumberAndIndex</li>
 * </ul>
 *
 * <p>See
 ...
 * details on additional Parity fields present in OkcBlock.</p>
 */
public class OkcBlock extends Response<OkcBlock.Block> {

    @Override
    @JsonDeserialize(using = OkcBlock.ResponseDeserialiser.class)
