 ...
 * okc_compileSolidity.
 */
public class OkcCompileSolidity extends Response<Map<String, OkcCompileSolidity.Code>> {
    ...
    public static class Documentation {
        ...
        // See https://github.com/ethereum/wiki/wiki/JSON-RPC#okc_compilesolidity
