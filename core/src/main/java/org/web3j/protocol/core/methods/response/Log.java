...
/**
 * <p>Log object used by {@link OkcLog} and {@link OkcGetTransactionReceipt}.</p>
 * <p>It's not clear in the
 * <a href="https://github.com/ethereum/wiki/wiki/JSON-RPC#okc_newfilter">docs</a>
 * If only a list of hashes are returned for filters created with okc_newBlockFilter or
 * okc_newPendingTransactionFilter.</p>
 */
public class Log {
