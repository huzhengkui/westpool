 ...
 * <a href="https://github.com/okcereum/EIPs/issues/20">EIP-20</a>. Solidity implementation is
...
public class HumanStandardTokenIT extends Scenario {
    ...
    private String sendCreateContractTransaction(
        ...
        OkcSendTransaction transactionResponse = web3j.okcSendRawTransaction(hexValue)
                .sendAsync().get();
