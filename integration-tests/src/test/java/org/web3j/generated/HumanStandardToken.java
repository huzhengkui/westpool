...
public class HumanStandardToken extends Contract {
    ...
    public Observable<ApprovalEventResponse> approvalEventObservable(OkcFilter filter) {
        return web3j.okcLogObservable(filter).map(new Func1<Log, ApprovalEventResponse>() {
            @Override
